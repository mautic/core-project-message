...
namespace Mautic\Composer\Plugin\ProjectMessage;
...
class Message {
  ...
  public function getText() {
    ...
    if ($config_file = $package_config['mautic-core-project-message'][$this->eventName . '-file'] ?? FALSE) {
      $file = $config_file;
    }

    $message = $package_config['mautic-core-project-message'][$this->eventName . '-message'] ?? [];
    ...
    if ($config_keys = $package_config['mautic-core-project-message']['include-keys'] ?? FALSE) {
